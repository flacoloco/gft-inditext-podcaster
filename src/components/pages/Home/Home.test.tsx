...
describe('Home', () => {
  ...
  it('should render loading state correctly', () => {
    mockUsePodcastListData.mockReturnValue([null, null]);
  ...
  it('should render error state and not crash', () => {
    ...
    mockUsePodcastListData.mockReturnValue([null, 'Test error']);

    renderHome();

    // Component should still render header but no search input or content when there's an error
    expect(screen.getByTestId('header')).toBeInTheDocument();
    expect(screen.queryByTestId('search-input')).not.toBeInTheDocument();
  ...
  it('should render podcasts when data is loaded successfully', async () => {
    mockUsePodcastListData.mockReturnValue([mockPodcastData, null]);
