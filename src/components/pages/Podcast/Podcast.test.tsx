...
describe('Podcast', () => {
  ...
  it('should render loading state correctly', () => {
    ...
    mockUsePodcastData.mockReturnValue([null, null]);
  ...
  it('should render error state and not crash', () => {
    ...
    mockUseParams.mockReturnValue({ podcastId: '123' });
    mockUsePodcastData.mockReturnValue([null, 'Test error']);
    localStorageMock.getItem.mockReturnValue(JSON.stringify(mockPodcastData));

    renderPodcast();

    // Component should still render header but no podcast card when there's an error
    expect(screen.getByTestId('header')).toBeInTheDocument();
  ...
  it('should render podcast card when podcast data is available', async () => {
    mockUseParams.mockReturnValue({ podcastId: '123' });
    mockUsePodcastData.mockReturnValue([mockEpisodeData, null]);
    localStorageMock.getItem.mockReturnValue(JSON.stringify(mockPodcastData));
  ...
  it('should not render episodes list when no episodes are available', async () => {
    mockUseParams.mockReturnValue({ podcastId: '123' });
    mockUsePodcastData.mockReturnValue([[], null]);
    localStorageMock.getItem.mockReturnValue(JSON.stringify(mockPodcastData));
  ...
  it('should handle data parsing errors gracefully', async () => {
    ...
    mockUsePodcastData.mockReturnValue([malformedData, null]);
    localStorageMock.getItem.mockReturnValue(JSON.stringify(mockPodcastData));
